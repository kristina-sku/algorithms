...
public class MergeSortComparison {
    ...
    private static List<Long> mergeSortTimes = new ArrayList<>();
    private static List<Long> parallelMergeSortTimes = new ArrayList<>();
    ...
    private void evaluateComparison() {
        ...
        float percentSaved = (float)((parallelMergeSortAvgTime / mergeSortAvgTime) * 100);
